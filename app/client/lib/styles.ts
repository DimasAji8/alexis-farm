...
export const styles = {
  ...
  table: {
    ...
    cellMuted: "text-slate-600 dark:text-slate-400 text-sm py-3",
    cellPrimary: "text-slate-900 dark:text-slate-100 text-sm py-3",
    cellSecondary: "text-slate-700 dark:text-slate-300 text-sm py-3",
    cellTertiary: "text-slate-600 dark:text-slate-400 text-sm py-3",
